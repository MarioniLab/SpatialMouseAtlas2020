---
title: "E8.5 seqFISH section experiment 102219"
...
only for the seqFISH library (not smFISH rounds), and includes the updated 
dot calls Nico provided on 24 April 2020.
...
```{r}
fov_info_file = "../Data/TimEmbryos-102219/output/cellinfo/fovinfo.csv"
mRNA_files_dir = "../Data/TimEmbryos-102219/output/1error-sqrt6-pointsratio-2020-05-22/"
cell_files_dir = "../Data/TimEmbryos-102219/output/1error-sqrt6-pointsratio-2020-05-22/"
segmentation_files_dir = "../Data/TimEmbryos-102219/segmentation/"

processed_dir = "../Data/TimEmbryos-102219/processed/"
processed_suffix = "102219"
...
```{r}
embryo_label = c(rep("embryo1", 29), rep("embryo2", 22))
names(embryo_label) <- paste0("fov.", 1:51)
